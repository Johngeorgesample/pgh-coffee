  ...
  return (
    <div className="bg-yellow-300 flex items-center py-2 px-2 gap-3">
      ...
      <div className="hidden sm:flex items-center gap-4">
        <a className="" href="https://github.com/Johngeorgesample/pgh-coffee" target="_blank">
          <svg width="34" height="34" viewBox="0 0 97.707 97.707" xmlns="http://www.w3.org/2000/svg">
            <path
        ...
        <a className="text-2xl" href="https://github.com/Johngeorgesample/pgh-coffee" target="_blank">
          GitHub
        </a>

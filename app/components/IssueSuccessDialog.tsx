...
export default function IssueSuccessDialog({ isOpen, handleClose }: IProps) {
  return (
                ...
                <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                  ...
                  <div className="mt-2">
                    <p className="text-sm text-gray-500">
                      Your correction is appreciated and will be reviewed. Updates may take a few days to appear on the site.
                    </p>
                  </div>
                </div>
              </div>

...
export default function ClaimSuccessDialog(props: TProps) {
  return (
                ...
                <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                  ...
                  <div className="mt-2">
                    <p className="text-sm text-gray-500">
                      Thanks! I review every claim by hand to confirm ownership before handing over the keys to a
                      listing. I&apos;ll reach out at the email you provided within a few days.
                    </p>
                  </div>
                </div>
              </div>
